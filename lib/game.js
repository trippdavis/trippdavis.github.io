(function () {
  ...
  Game.prototype.allObjects = function () {
    return this.refills.concat(this.asteroids).concat([this.ship]).concat(this.bullets).concat(this.lasers);
  };
  ...
  Game.prototype.showStats = function () {
    ...
    this.ctx.fillText("Gun: " + this.ship.currentGun, 10, 90);
    this.ctx.fillText("Ammo: " + this.ship.guns[this.ship.currentGun], 10, 120);
  };
  ...
  Game.prototype.checkCollisions = function () {
    ...
    while (i < this.asteroids.length) {
      var asteroid = this.asteroids[i];
      if (!this.ship.safeTime && asteroid.isCollidedWith(this.ship)) {
  ...
  Game.prototype.step = function () {
    ...
    } else if (this.ship.safeTime) {
      this.ship.decreaseSafeTime();
    }
  };
