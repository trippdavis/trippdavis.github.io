(function () {
  ...
  Ship.prototype.shootPistol = function () {
    var gunshotSound = new Audio("audio/gunshot.wav");
    gunshotSound.volume = 0.12;
    gunshotSound.play();
  ...
  Ship.prototype.shootShotgun = function () {
    var shotgunSound = new Audio("audio/shotgun.wav");
  ...
  Ship.prototype.ammoRefill = function (type) {
    var refillAudio = new Audio("audio/refill.wav");
    refillAudio.play();
